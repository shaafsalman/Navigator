package com.example.navigation_smd_7a.Fragment;
...
import com.example.navigation_smd_7a.Adapter.ProductAdapter;
...
public class NewOrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ProductDao.open();
        ArrayList<Product> products = ProductDao.fetchAll();
        ProductDao.close();
